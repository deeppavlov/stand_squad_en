...
predict_file = os.path.join(home, "datasets", "squad", "task_private.json_squad")
glove_word_file = os.path.join(home, "data", "glove", "glove.840B.300d.txt")

suff = "char_300_pretrained_train_full_eng"
...
flags.DEFINE_integer("pos_dim", 20, "Embedding dimension for POS tags")
...
flags.DEFINE_float("min_lr", 1e-03, "min value for learning rate")
...
glove_char_file = os.path.join(home, "datasets", "glove.840B.300d-char.txt")
...
fasttext_file = os.path.join(home, "datasets", "wiki-news-300d-1M.vec")
...
flags.DEFINE_boolean("use_bpe", False, "Use BPE embeddings")
flags.DEFINE_boolean("use_bpe_pretrained_codes", False, "Use pretrained BPE codes")
...
flags.DEFINE_boolean("pretrained_bpe_emb", False, "Whether to use pretrained BPE embedding")
flags.DEFINE_boolean("train_pretrained_bpe_emb", False, "Train pretrained BPE embedding or use unchanged")

flags.DEFINE_integer("freeze_steps", 0, "Number of training steps when pretrained weights are freezed")
flags.DEFINE_boolean("use_pos", False, "Use POS tags")

flags.DEFINE_string("sber_public_file",
                    os.path.join(home, 'datasets', 'sbersquad', 'task_public.json'),
                    "Sber public test path")

flags.DEFINE_string("sber_private_file",
                    os.path.join(home, 'datasets', 'sbersquad', 'task_private.json'),
